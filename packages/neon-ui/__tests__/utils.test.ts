...
import { el, queryAll, query, sleep, debounce, throttle, on, createElement } from '../src/utils';
...
describe('createElement', () => {
  ...
  it('ignores non-string, non-node children', () => {
    const element = createElement('div', {}, [null as unknown as string, undefined as unknown as string, 123 as unknown as string]);
