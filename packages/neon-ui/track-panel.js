 ...
 * @param {string} [options.description=''] - Initial description
 * @param {string} [options.thumbnailUrl=null] - Initial thumbnail URL
 * @param {boolean} [options.compact=false] - Use compact layout
 * @param {boolean} [options.descriptionVisible=false] - Show description by default
 * @param {string} [options.titlePlaceholder='TRACK TITLE'] - Title placeholder
 * @param {string} [options.descriptionPlaceholder='Add a description...'] - Description placeholder
 * @param {Function} [options.onTitleChange] - Called on title input (title) => void
 * @param {Function} [options.onDescriptionChange] - Called on description input (desc) => void
 * @param {Function} [options.onThumbnailClick] - Called when thumbnail is clicked () => void
 * @param {Function} [options.onBriefToggle] - Called when brief visibility is toggled (visible) => void
 * @returns {Object} { element, setTitle, setDescription, setThumbnail, setThumbnailLoading, showDescription, getTitle, getDescription, destroy }
 */
export function createTrackPanel(options = {}) {
    injectStyles();
