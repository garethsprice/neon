...
import type { NeonColor, PanelOptions, PanelComponent } from './types';
...
/** Panel color type */
export type PanelColor = 'default' | NeonColor;

/**
 * Create a panel container
 */
export function createPanel(options: PanelOptions = {}): PanelComponent {
  injectStyles();
  ...
  return {
    ...
    setColor: (newColor: PanelColor): void => {
