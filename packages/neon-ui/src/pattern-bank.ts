...
export interface PatternBankOptions {
    ...
    onCopy?: (fromId: PatternId, toId: PatternId) => void;
    onClear?: (id: PatternId) => void;
}

/** Pattern bank component interface */
 ...
 */
export function createPatternBank(options: PatternBankOptions = {}): PatternBankComponent {
    injectStyles();
    ...
    let activePatternId: PatternId = 'A';
    let copySourceId: PatternId | null = null;
    const patternHasData: Record<string, boolean> = {};
    const slots: Record<string, HTMLButtonElement> = {};
    ...
    function handleSlotClick(id: PatternId, e: MouseEvent): void {
    ...
    function handleClear(id: PatternId): void {
        if (onClear) {
            onClear(id);
        }
    }
    ...
    function setPatternHasData(id: PatternId, hasData: boolean): void {
    ...
    function getActivePattern(): PatternId {
