 ...
 * @param {string} [options.color='cyan'] - Color when active: cyan, magenta, green, orange, purple
 * @param {boolean} [options.empty=false] - Whether button represents empty content
 * @param {Function} [options.onClick] - Click handler
 * @param {Function} [options.onDoubleClick] - Double-click handler
 * @param {boolean} [options.toggle=false] - Whether clicking toggles the state
 * @param {boolean} [options.disabled=false] - Whether button is disabled
 * @param {string} [options.content] - Inner content/text
 * @returns {Object} { element, button, isActive, setActive, setEmpty, trigger, setPulse, destroy }
 */
export function createMachineButton(options = {}) {
    injectStyles();
