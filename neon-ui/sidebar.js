 ...
 * @param {string} [options.color='magenta'] - Border color: magenta, cyan, green, purple
 * @param {boolean} [options.showBackdrop=true] - Show backdrop when open
 * @param {boolean} [options.closeOnBackdrop=true] - Close when clicking backdrop
 * @param {HTMLElement|string} [options.content] - Initial content
 * @param {Function} [options.onOpen] - Called when sidebar opens
 * @param {Function} [options.onClose] - Called when sidebar closes
 * @returns {Object} { element, open, close, toggle, isOpen, setContent, destroy }
 */
