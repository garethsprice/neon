            ...
            if (isDemo) {
                ...
                if (!hasCreativeBrief && !hasExistingContent) {
                    ...
                    try {
                        ...
                        const [detectedSkill, creativeBrief] = await Promise.all([
                            detectSkillWithAI(prompt),
                        ...
                        if (!this.trackSkill) {
                            this.trackSkill = detectSkillFromKeywords(prompt);
                        }
                    }
                }
                ...
                // Build system prompt using extracted helper
